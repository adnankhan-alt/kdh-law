...
module.exports = async function handler(req, res) {
  ...
  <main id="main"><section class="seo-hero"><div class="seo-wrap seo-hero-grid"><div><p class="seo-kicker">Legal services in Kenya</p><h1>Commercial legal expertise for <em>complex business decisions.</em></h1></div><p class="seo-lead">KDH Advocates provides multidisciplinary legal advice across transactions, disputes, finance, property, employment, technology, trade, tax, investment and major projects.</p></div></section>
