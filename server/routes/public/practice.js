...
module.exports = async function handler(req, res) {
  ...
  const questions = (seoCopy.questions || []).map(([question, answer]) => `<article class="seo-question"><h3>${escapeHtml(question)}</h3><p>${escapeHtml(answer)}</p></article>`).join('');
