...
<body class="article-page">
  ...
  <main id="main">
    ...
    <article class="article-shell">
      <header class="article-header"><div class="article-kicker">KDH Insights</div><h1>${escapeHtml(post.title || 'KDH Insight')}</h1>${summary}<div class="article-meta"><span>${escapeHtml(formatDate(published))}</span>${authorPerson ? '' : `<span>By ${authorHtml}</span>`}<span>${readingMinutes(post.content)} min read</span></div>${authorCard}<div class="article-share-top"><a class="linkedin-share" href="${escapeHtml(linkedInShare)}" target="_blank" rel="noopener noreferrer">LinkedIn <span aria-hidden="true">↗</span></a><a class="social-share" href="${escapeHtml(facebookShare)}" target="_blank" rel="noopener noreferrer">Facebook <span aria-hidden="true">↗</span></a><a class="social-share" href="${escapeHtml(xShare)}" target="_blank" rel="noopener noreferrer">X <span aria-hidden="true">↗</span></a></div></header>
