...
module.exports = async function handler(req, res) {
  ...
  <main id="main"><section class="seo-hero"><div class="seo-wrap seo-hero-grid"><div><p class="seo-kicker">Consultation</p><h1>Your next move deserves <em>legal clarity.</em></h1></div><p class="seo-lead">Contact KDH Advocates to discuss a commercial, transactional, regulatory or dispute matter. The firm prioritises understanding the client’s objectives before recommending a legal strategy.</p></div></section>
