...
module.exports = async function handler(req, res) {
  ...
  <main id="main"><section class="seo-hero"><div class="seo-wrap seo-hero-grid"><div><p class="seo-kicker">KDH legal team</p><h1>Lawyers combining specialist depth with <em>commercial judgment.</em></h1></div><p class="seo-lead">Meet the KDH Advocates team in Nairobi and explore each lawyer’s areas of focus, profile, LinkedIn presence and published legal analysis.</p></div></section>
