...
module.exports = async function handler(req, res) {
  ...
  <main id="main"><section class="seo-hero"><img class="blue-band-logo" src="/assets/kdh-law-logo-transparent.png" alt="" aria-hidden="true"><div class="seo-wrap seo-hero-grid"><div><p class="seo-kicker">KDH Advocates LLP · Nairobi, Kenya</p><h1>Commercial counsel built around <em>clarity, trust and results.</em></h1></div><p class="seo-lead">KDH Advocates LLP, formerly Ken, Daniel &amp; Henry Advocates, combines commercial legal advice, dispute strategy and cross-border capability for businesses operating in Kenya and across Africa.</p></div></section>
  <div class="seo-main">
